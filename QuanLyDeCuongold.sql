...
insert into KHOA(MaKhoa, TenKhoa, TruongKhoa) values ('SP&KHCB', N'Sư Phạm và khoa học cơ bạn', 'GV0105')
insert into KHOA(MaKhoa, TenKhoa, TruongKhoa) values ('KTL', N'Kinh Tế Luật', 'GV0106')
...
insert into Permission (MaPermission, Actions) values (1, 'read/giangvien'),(2, 'create/giangvien'), (3, 'update/giangvien'), (4, 'delete/giangvien')
...
select * from NGANH where MaNganh='CNKTCK'
select * from NAMHOC
select * from MONHOC
select * from LOP
select * from KHOA 
